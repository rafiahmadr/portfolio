  ...
  return (
    ...
    >
      <section className="text-center max-w-3xl mx-auto space-y-6">
        ...
        <h1 className="text-5xl font-medium tracking-normal mb-6">
        ...
        <div className="flex flex-col items-center gap-4">
          {aboutData.experience.map((item, i) => (
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-1 mt-1">{item.company}</h3>
        ...
        <div className="flex flex-col items-center gap-4">
          {aboutData.projects.map((item, i) => (
            ...
            >
              ...
              <p className="text-sm text-neutral-500 mb-5">{item.desc}</p>
